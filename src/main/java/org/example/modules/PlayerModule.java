...
public class PlayerModule {
	...
	private static void displayPlayerByName() {
		...
		System.out.println("\n-----------------------Player List----------------------------------------");
		int count = 1;
		while (count < byPlayerName.size()) {
			byPlayerName.forEach(player -> System.out.println("PlayerID: " + count + " PlayerNameSurname: " + player.getPersonName() + " " + player.getPersonSurname()));
		}
		displayPlayerDetails();
	}
